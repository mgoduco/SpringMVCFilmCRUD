...
<body>
	...
	<form action="createFilm.do" method="POST">
      ...
      <input type="text" name="title" value="your film name">
      <br>
      <label for="description">Description of Film:</label>
      <input type="text" name="description" value="describe your film">
      <br>
      <label for="release_year">Release year:</label>
      <input type="text" name="release_year" value="2022">
      <br>
      ...
      <input type="text" name="rental_duration" value="3">
      <br>
      <label for="rental_rate">rental_rate:</label>
      <input type="text" name="rental_rate" value="4.99">
      <br>
      ...
      <input type="text" name="rating" value="R">
      <br>
